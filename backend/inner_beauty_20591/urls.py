"""inner_beauty_20591 URL Configuration
...
admin.site.site_header = "Inner Beauty"
admin.site.site_title = "Inner Beauty Admin Portal"
admin.site.index_title = "Inner Beauty Admin"

# swagger
api_info = openapi.Info(
    title="Inner Beauty API",
    default_version="v1",
    description="API documentation for Inner Beauty App",
)
